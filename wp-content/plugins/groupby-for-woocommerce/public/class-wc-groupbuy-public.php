        ...
        if (method_exists( $product, 'get_type') && $product->get_type() == 'groupbuy' ) {
            ...
            if ( $max_deals_per_user == false ) {
             ...
             if ( !is_user_logged_in() ) {
                ...
                wc_add_notice(sprintf(__('Sorry, you must be logged in to participate in Group Buy deal. <a href="%s" class="button">Login &rarr;</a> <a href="/signup/" class="button bwbutton">Register &rarr;</a>', 'wc_groupbuy'), get_permalink(wc_get_page_id('myaccount'))), 'error');
                return false;
            }
